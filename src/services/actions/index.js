...
export const OPEN_ORDER_MODAL = "OPEN_INGREDIENT_MODAL";
export const CLOSE_ORDER_MODAL = 'CLOSE_INGREDIENT_MODAL';
...
export const GET_FORGOT_PASSWORD_REQUEST = 'GET_FORGOT_REQUEST';
export const GET_FORGOT_PASSWORD_SUCCESS = 'GET_FORGOT_SUCCESS';
export const GET_FORGOT_PASSWORD_ERROR = 'GET_FORGOT_ERROR';

export const GET_RESET_PASSWORD_REQUEST = 'GET_RECOVERY_PASSWORD_REQUEST';
export const GET_RESET_PASSWORD_SUCCESS = 'GET_RECOVERY_PASSWORD_SUCCESS';
export const GET_RESET_PASSWORD_ERROR = 'GET_RECOVERY_PASSWORD_ERROR';
